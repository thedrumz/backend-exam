...
describe('Test eventsValidator', () => {
  it('Validate events for valid input', () => {
    const input = {
      name: 'Evento 1',
      type: 'Danza',
      date: '23/12/2019',
    ...
    assert.equal(true, utils.eventsValidator(input));
  });

  it('Validate events with empty field', () => {
    const input = {
      name: 'Evento 1',
      type: '',
      date: '23/12/2019',
    ...
    assert.equal(false, utils.eventsValidator(input));
  });

  it('Validate events without mandatory field', () => {
    const input = {
      type: 'Teatro',
      date: '23/12/2019',
      place: 'Madrid',
  ...
  it('Validate events with invalid date', () => {
    const input = {
      name: 'Evento 1',
      type: 'Teatro',
      date: '2019/12/30',
